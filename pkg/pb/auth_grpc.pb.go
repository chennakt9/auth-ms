...
type AuthServiceClient interface {
	HealthCheck(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*HealthCheckResponse, error)
...
func (c *authServiceClient) HealthCheck(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
...
type AuthServiceServer interface {
	HealthCheck(context.Context, *NoParam) (*HealthCheckResponse, error)
...
func (UnimplementedAuthServiceServer) HealthCheck(context.Context, *NoParam) (*HealthCheckResponse, error) {
...
func _AuthService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).HealthCheck(ctx, req.(*NoParam))
	}
